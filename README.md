...
Пришлось найти сборку (уже не помню, где я её нашёл) и внедрить самостоятельно  
в `Sublime Text\Packages\MarkdownPreviewEnhanced`. Прямо со старта он дал мне  
возможность лицезреть html, через `ctrl+shift+p`. Это было круто!  
