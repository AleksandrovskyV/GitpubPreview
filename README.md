...
Поэтому я искал решение в виде плагина к установленому на моём ПК  
Sublime Text build 4200, чтобы смотреть файлы локально  
...
#### Было бы хорошо:
правильно обернуть body, чтобы на телефоне вёрстка  
соответствовала 1в1 (сейчас неправильный сайз)  

"ссылки" c style="color=black;" на уровне .md, сжираются  
всё равно отобразятся color=blue  